...
<?= $this->section('title') ?>Tambah Jenis Kasus<?= $this->endSection() ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kode_jenis" name="kode_jenis"
                            placeholder="Contoh: KDRT, NARK, CURANMOR" maxlength="20" style="text-transform: uppercase;" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_jenis" name="nama_jenis"
                            placeholder="Contoh: Kekerasan Dalam Rumah Tangga" maxlength="255" required>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4"
                            placeholder="Deskripsi detail tentang jenis kasus ini (opsional)"></textarea>
...
<script>
    $(document).ready(function() {
        ...
        $('#formJenisKasus').on('submit', function(e) {
            ...
            // AJAX request
            $.ajax({
                url: '<?= base_url('spkt/jenis-kasus/store') ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
