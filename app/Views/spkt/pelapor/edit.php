...
<?= $this->section('title') ?>Edit Data Pelapor<?= $this->endSection() ?>
...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">
            ...
            Edit Data Pelapor: <?= esc($pelapor['nama']) ?>
        </h3>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama"
                            value="<?= esc($pelapor['nama']) ?>" placeholder="Masukkan nama lengkap" maxlength="255" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nik" name="nik"
                            value="<?= esc($pelapor['nik']) ?>" placeholder="Nomor Induk Kependudukan" maxlength="20">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jenis_kelamin" name="jenis_kelamin">
                                    ...
                                    <option value="L" <?= $pelapor['jenis_kelamin'] == 'L' ? 'selected' : '' ?>>Laki-laki</option>
                                    <option value="P" <?= $pelapor['jenis_kelamin'] == 'P' ? 'selected' : '' ?>>Perempuan</option>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                            value="<?= esc($pelapor['pekerjaan']) ?>" placeholder="Pekerjaan/profesi" maxlength="100">
                ...
                <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="telepon" name="telepon"
                                    value="<?= esc($pelapor['telepon']) ?>" placeholder="Nomor telepon/HP" maxlength="20">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    value="<?= esc($pelapor['email']) ?>" placeholder="Alamat email" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="alamat" name="alamat" rows="3"
                            placeholder="Alamat lengkap (jalan, RT/RW, dll)"><?= esc($pelapor['alamat']) ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kelurahan" name="kelurahan"
                                    value="<?= esc($pelapor['kelurahan']) ?>" placeholder="Kelurahan/Desa" maxlength="100">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kecamatan" name="kecamatan"
                                    value="<?= esc($pelapor['kecamatan']) ?>" placeholder="Kecamatan" maxlength="100">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kota_kabupaten" name="kota_kabupaten"
                                    value="<?= esc($pelapor['kota_kabupaten']) ?>" placeholder="Kota/Kabupaten" maxlength="100">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="provinsi" name="provinsi"
                                    value="<?= esc($pelapor['provinsi']) ?>" placeholder="Provinsi" maxlength="100">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kode_pos" name="kode_pos"
                            value="<?= esc($pelapor['kode_pos']) ?>" placeholder="Kode pos" maxlength="10">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3"
                            placeholder="Keterangan tambahan (opsional)"><?= esc($pelapor['keterangan']) ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <button type="submit" class="btn btn-warning" id="btnSubmit">
                        <i class="fas fa-save mr-1"></i> Perbarui Data Pelapor
                    </button>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#formPelapor').on('submit', function(e) {
            ...
            // AJAX request
            $.ajax({
                url: '<?= base_url('spkt/pelapor/update/' . $pelapor['id']) ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
