...
<head>
    ...
    <title>Laporan Data Tersangka - Polsek Lunang Silaut</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="report-info">
            <table>
                <tr>
                    <td class="label">Total Tersangka</td>
                    <td>: <?= $totalTersangka ?> orang</td>
                </tr>
                <tr>
        ...
        <?php if (!empty($tersangkaData)): ?>
            <table class="data-table">
                ...
                <tbody>
                    <?php foreach ($tersangkaData as $index => $tersangka): ?>
                        <tr>
                            <td style="text-align: center;"><?= $index + 1 ?></td>
                            <td><?= $tersangka['nama'] ?></td>
                            <td><?= $tersangka['nik'] ?: '-' ?></td>
                            <td style="text-align: center;"><?= substr(ucfirst($tersangka['jenis_kelamin']), 0, 1) ?></td>
                            <td style="text-align: center;"><?= $tersangka['umur'] ?></td>
                            <td><?= $tersangka['alamat'] ?: '-' ?></td>
                            <td style="text-align: center;">
                                <?php
                                $statusLabel = match ($tersangka['status_tersangka']) {
                                    'dpo' => 'DPO',
                                    'tersangka' => 'Tersangka',
                                    'terdakwa' => 'Terdakwa',
                                    'terpidana' => 'Terpidana',
                                    default => ucfirst(str_replace('_', ' ', $tersangka['status_tersangka']))
                                };
                                echo $statusLabel;
                                ?>
                            </td>
        ...
        <?php else: ?>
            <div class="no-data">
                <h4>Tidak ada data tersangka yang tersedia.</h4>
                <p>Belum ada tersangka yang terdaftar dalam sistem.</p>
            </div>
        <?php endif; ?>
