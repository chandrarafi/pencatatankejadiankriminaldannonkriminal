...
<head>
    ...
    <title>Laporan Data Korban - Polsek Lunang Silaut</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="report-info">
            <table>
                <tr>
                    <td class="label">Total Korban</td>
                    <td>: <?= $totalKorban ?> orang</td>
                </tr>
                <tr>
        ...
        <?php if (!empty($korbanData)): ?>
            <table class="data-table">
                ...
                <tbody>
                    <?php foreach ($korbanData as $index => $korban): ?>
                        <tr>
                            <td style="text-align: center;"><?= $index + 1 ?></td>
                            <td><?= $korban['nama'] ?></td>
                            <td><?= $korban['nik'] ?: '-' ?></td>
                            <td style="text-align: center;"><?= substr(ucfirst($korban['jenis_kelamin']), 0, 1) ?></td>
        ...
        <?php else: ?>
            <div class="no-data">
                <h4>Tidak ada data korban yang tersedia.</h4>
                <p>Belum ada korban yang terdaftar dalam sistem.</p>
            </div>
        <?php endif; ?>
