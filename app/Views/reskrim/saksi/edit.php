...
<?= $this->section('title') ?>Edit Data Saksi<?= $this->endSection() ?>
...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">
            ...
            Form Edit Data Saksi - <?= $saksi['nama'] ?>
        </h3>
    </div>

    <form action="<?= base_url('reskrim/saksi/update/' . $saksi['id']) ?>" method="post" id="formSaksi">
        <?= csrf_field() ?>
                ...
                <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="hidden" id="kasus_id" name="kasus_id" value="<?= old('kasus_id', $saksi['kasus_id']) ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('errors') && isset(session()->getFlashdata('errors')['nama'])) ? 'is-invalid' : '' ?>"
                                    id="nama" name="nama" value="<?= old('nama', $saksi['nama']) ?>"
                                    placeholder="Masukkan nama lengkap saksi" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nik" name="nik"
                                    value="<?= old('nik', $saksi['nik']) ?>" placeholder="Nomor Induk Kependudukan">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" required>
                                    ...
                                    <option value="L" <?= old('jenis_kelamin', $saksi['jenis_kelamin']) == 'L' ? 'selected' : '' ?>>Laki-laki</option>
                                    <option value="P" <?= old('jenis_kelamin', $saksi['jenis_kelamin']) == 'P' ? 'selected' : '' ?>>Perempuan</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="umur" name="umur"
                                    value="<?= old('umur', $saksi['umur']) ?>" placeholder="Umur" min="0" max="150">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                    value="<?= old('pekerjaan', $saksi['pekerjaan']) ?>" placeholder="Pekerjaan saksi">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="jenis_saksi">Jenis Saksi <span class="text-danger">*</span></label>
                                <select class="form-control" id="jenis_saksi" name="jenis_saksi" required>
                                    <option value="">-- Pilih Jenis Saksi --</option>
                                    <option value="ahli" <?= old('jenis_saksi', $saksi['jenis_saksi']) == 'ahli' ? 'selected' : '' ?>>Saksi Ahli</option>
                                    <option value="fakta" <?= old('jenis_saksi', $saksi['jenis_saksi']) == 'fakta' ? 'selected' : '' ?>>Saksi Fakta</option>
                                    <option value="korban" <?= old('jenis_saksi', $saksi['jenis_saksi']) == 'korban' ? 'selected' : '' ?>>Korban sebagai Saksi</option>
                                    <option value="mahkota" <?= old('jenis_saksi', $saksi['jenis_saksi']) == 'mahkota' ? 'selected' : '' ?>>Saksi Mahkota</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="telepon" name="telepon"
                                    value="<?= old('telepon', $saksi['telepon']) ?>" placeholder="Nomor telepon">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    value="<?= old('email', $saksi['email']) ?>" placeholder="Alamat email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="hubungan_dengan_korban" name="hubungan_dengan_korban"
                                    value="<?= old('hubungan_dengan_korban', $saksi['hubungan_dengan_korban']) ?>" placeholder="Contoh: Keluarga, Teman, Tidak dikenal, dll">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="hubungan_dengan_tersangka">Hubungan dengan Tersangka</label>
                                <input type="text" class="form-control" id="hubungan_dengan_tersangka" name="hubungan_dengan_tersangka"
                                    value="<?= old('hubungan_dengan_tersangka', $saksi['hubungan_dengan_tersangka']) ?>" placeholder="Contoh: Keluarga, Teman, Tidak dikenal, dll">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="alamat" name="alamat" rows="3"
                            placeholder="Alamat lengkap saksi" required><?= old('alamat', $saksi['alamat']) ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="keterangan_kesaksian">Keterangan Kesaksian</label>
                        <textarea class="form-control" id="keterangan_kesaksian" name="keterangan_kesaksian" rows="3"
                            placeholder="Detail kesaksian atau hal yang disaksikan"><?= old('keterangan_kesaksian', $saksi['keterangan_kesaksian']) ?></textarea>
                    </div>

                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="dapat_dihubungi" name="dapat_dihubungi"
                                value="1" <?= old('dapat_dihubungi', $saksi['dapat_dihubungi']) ? 'checked' : '' ?>>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="2"
                            placeholder="Keterangan tambahan mengenai saksi"><?= old('keterangan', $saksi['keterangan']) ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-md-6">
                    <a href="<?= base_url('reskrim/saksi') ?>" class="btn btn-secondary">
...
<script>
    $(document).ready(function() {
        ...
        <?php if (!empty($saksi['kasus_id'])): ?>
            $.ajax({
                url: '<?= base_url('reskrim/saksi/get-kasus-data') ?>',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
                        let selectedKasus = response.data.find(k => k.id == '<?= $saksi['kasus_id'] ?>');
                        if (selectedKasus) {
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            window.location.href = '<?= base_url('reskrim/saksi') ?>';
                        });
                    } else {
