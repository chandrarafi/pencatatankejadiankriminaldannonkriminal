...
<?= $this->section('title') ?>Tambah Data Saksi<?= $this->endSection() ?>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">
            ...
            Form Tambah Data Saksi
        </h3>
    </div>

    <form action="<?= base_url('reskrim/saksi/store') ?>" method="post" id="formSaksi">
        <?= csrf_field() ?>
                ...
                <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                    value="<?= old('pekerjaan') ?>" placeholder="Pekerjaan saksi">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jenis_saksi" name="jenis_saksi" required>
                                    ...
                                    <option value="ahli" <?= old('jenis_saksi') == 'ahli' ? 'selected' : '' ?>>Saksi Ahli</option>
                                    <option value="fakta" <?= old('jenis_saksi') == 'fakta' ? 'selected' : '' ?>>Saksi Fakta</option>
                                    <option value="korban" <?= old('jenis_saksi') == 'korban' ? 'selected' : '' ?>>Korban sebagai Saksi</option>
                                    <option value="mahkota" <?= old('jenis_saksi') == 'mahkota' ? 'selected' : '' ?>>Saksi Mahkota</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="hubungan_dengan_korban" name="hubungan_dengan_korban"
                                    value="<?= old('hubungan_dengan_korban') ?>" placeholder="Contoh: Keluarga, Teman, Tidak dikenal, dll">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="hubungan_dengan_tersangka" name="hubungan_dengan_tersangka"
                                    value="<?= old('hubungan_dengan_tersangka') ?>" placeholder="Contoh: Keluarga, Teman, Tidak dikenal, dll">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="alamat" name="alamat" rows="3"
                            placeholder="Alamat lengkap saksi" required><?= old('alamat') ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="keterangan_kesaksian" name="keterangan_kesaksian" rows="3"
                            placeholder="Detail kesaksian atau hal yang disaksikan"><?= old('keterangan_kesaksian') ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="2"
                            placeholder="Keterangan tambahan mengenai saksi"><?= old('keterangan') ?></textarea>
                    </div>
                </div>
            </div>
        </div>
