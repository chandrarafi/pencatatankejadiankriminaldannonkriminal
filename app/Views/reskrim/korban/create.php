...
<?= $this->section('title') ?>Tambah Data Korban<?= $this->endSection() ?>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">
            ...
            Form Tambah Data Korban
        </h3>
    </div>

    <form action="<?= base_url('reskrim/korban/store') ?>" method="post" id="formKorban">
        <?= csrf_field() ?>
                ...
                <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                    value="<?= old('pekerjaan') ?>" placeholder="Pekerjaan korban">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status_korban" name="status_korban" required>
                                    ...
                                    <option value="hidup" <?= old('status_korban') == 'hidup' ? 'selected' : '' ?>>Hidup</option>
                                    <option value="meninggal" <?= old('status_korban') == 'meninggal' ? 'selected' : '' ?>>Meninggal</option>
                                    <option value="hilang" <?= old('status_korban') == 'hilang' ? 'selected' : '' ?>>Hilang</option>
                                    <option value="luka" <?= old('status_korban') == 'luka' ? 'selected' : '' ?>>Luka</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="hubungan_pelaku" name="hubungan_pelaku"
                                    value="<?= old('hubungan_pelaku') ?>" placeholder="Contoh: Tidak dikenal, Keluarga, Teman, dll">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="3"
                                    placeholder="Alamat lengkap korban" required><?= old('alamat') ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="keterangan_luka" name="keterangan_luka" rows="2"
                            placeholder="Keterangan detail mengenai luka yang dialami"><?= old('keterangan_luka') ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="keterangan">Keterangan Tambahan</label>
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="2"
                            placeholder="Keterangan tambahan mengenai korban"><?= old('keterangan') ?></textarea>
                    </div>
                </div>
            </div>
        </div>
