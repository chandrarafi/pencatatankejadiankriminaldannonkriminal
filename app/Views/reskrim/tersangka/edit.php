...
<?= $this->section('title') ?>Edit Data Tersangka<?= $this->endSection() ?>
...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">
            ...
            Form Edit Data Tersangka - <?= $tersangka['nama'] ?>
        </h3>
    </div>

    <form action="<?= base_url('reskrim/tersangka/update/' . $tersangka['id']) ?>" method="post" id="formTersangka">
        <?= csrf_field() ?>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="hidden" id="kasus_id" name="kasus_id" value="<?= old('kasus_id', $tersangka['kasus_id']) ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= (session()->getFlashdata('errors') && isset(session()->getFlashdata('errors')['nama'])) ? 'is-invalid' : '' ?>"
                                    id="nama" name="nama" value="<?= old('nama', $tersangka['nama']) ?>"
                                    placeholder="Masukkan nama lengkap tersangka" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nik" name="nik"
                                    value="<?= old('nik', $tersangka['nik']) ?>" placeholder="Nomor Induk Kependudukan">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" required>
                                    ...
                                    <option value="L" <?= old('jenis_kelamin', $tersangka['jenis_kelamin']) == 'L' ? 'selected' : '' ?>>Laki-laki</option>
                                    <option value="P" <?= old('jenis_kelamin', $tersangka['jenis_kelamin']) == 'P' ? 'selected' : '' ?>>Perempuan</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="umur" name="umur"
                                    value="<?= old('umur', $tersangka['umur']) ?>" placeholder="Umur" min="0" max="150">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                    value="<?= old('pekerjaan', $tersangka['pekerjaan']) ?>" placeholder="Pekerjaan tersangka">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="status_tersangka">Status Tersangka <span class="text-danger">*</span></label>
                                <select class="form-control" id="status_tersangka" name="status_tersangka" required>
                                    <option value="">-- Pilih Status --</option>
                                    <option value="ditetapkan" <?= old('status_tersangka', $tersangka['status_tersangka']) == 'ditetapkan' ? 'selected' : '' ?>>Ditetapkan</option>
                                    <option value="ditahan" <?= old('status_tersangka', $tersangka['status_tersangka']) == 'ditahan' ? 'selected' : '' ?>>Ditahan</option>
                                    <option value="dibebaskan" <?= old('status_tersangka', $tersangka['status_tersangka']) == 'dibebaskan' ? 'selected' : '' ?>>Dibebaskan</option>
                                    <option value="buron" <?= old('status_tersangka', $tersangka['status_tersangka']) == 'buron' ? 'selected' : '' ?>>Buron</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="telepon" name="telepon"
                                    value="<?= old('telepon', $tersangka['telepon']) ?>" placeholder="Nomor telepon">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    value="<?= old('email', $tersangka['email']) ?>" placeholder="Alamat email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tempat_penahanan">Tempat Penahanan</label>
                                <input type="text" class="form-control" id="tempat_penahanan" name="tempat_penahanan"
                                    value="<?= old('tempat_penahanan', $tersangka['tempat_penahanan']) ?>" placeholder="Contoh: Polsek Lunang Silaut, Rutan Solok, dll">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tanggal_penahanan">Tanggal Penahanan</label>
                                <input type="date" class="form-control" id="tanggal_penahanan" name="tanggal_penahanan"
                                    value="<?= old('tanggal_penahanan', $tersangka['tanggal_penahanan']) ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="alamat" name="alamat" rows="3"
                            placeholder="Alamat lengkap tersangka" required><?= old('alamat', $tersangka['alamat']) ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="pasal_yang_disangkakan">Pasal yang Disangkakan</label>
                        <textarea class="form-control" id="pasal_yang_disangkakan" name="pasal_yang_disangkakan" rows="2"
                            placeholder="Pasal-pasal yang disangkakan kepada tersangka"><?= old('pasal_yang_disangkakan', $tersangka['pasal_yang_disangkakan']) ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="barang_bukti">Barang Bukti</label>
                        <textarea class="form-control" id="barang_bukti" name="barang_bukti" rows="2"
                            placeholder="Daftar barang bukti yang berkaitan dengan tersangka"><?= old('barang_bukti', $tersangka['barang_bukti']) ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="keterangan">Keterangan Tambahan</label>
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="2"
                            placeholder="Keterangan tambahan mengenai tersangka"><?= old('keterangan', $tersangka['keterangan']) ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-md-6">
                    <a href="<?= base_url('reskrim/tersangka') ?>" class="btn btn-secondary">
...
<script>
    $(document).ready(function() {
        ...
        // Pre-populate kasus display if editing
        <?php if (!empty($tersangka['kasus_id'])): ?>
            $.ajax({
                url: '<?= base_url('reskrim/tersangka/get-kasus-data') ?>',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
                        let selectedKasus = response.data.find(k => k.id == '<?= $tersangka['kasus_id'] ?>');
                        if (selectedKasus) {
        ...
        $('#formTersangka').on('submit', function(e) {
            e.preventDefault();
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            window.location.href = '<?= base_url('reskrim/tersangka') ?>';
                        });
                    } else {
