...
<?= $this->section('title') ?>Tambah Data Tersangka<?= $this->endSection() ?>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">
            ...
            Form Tambah Data Tersangka
        </h3>
    </div>

    <form action="<?= base_url('reskrim/tersangka/store') ?>" method="post" id="formTersangka">
        <?= csrf_field() ?>
                ...
                <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="hidden" id="kasus_id" name="kasus_id" value="<?= old('kasus_id') ?>" required>
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#kasusModal">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="umur" name="umur"
                                    value="<?= old('umur') ?>" placeholder="Umur" min="0" max="150">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                    value="<?= old('pekerjaan') ?>" placeholder="Pekerjaan tersangka">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status_tersangka" name="status_tersangka" required>
                                    ...
                                    <option value="ditetapkan" <?= old('status_tersangka') == 'ditetapkan' ? 'selected' : '' ?>>Ditetapkan</option>
                                    <option value="ditahan" <?= old('status_tersangka') == 'ditahan' ? 'selected' : '' ?>>Ditahan</option>
                                    <option value="dibebaskan" <?= old('status_tersangka') == 'dibebaskan' ? 'selected' : '' ?>>Dibebaskan</option>
                                    <option value="buron" <?= old('status_tersangka') == 'buron' ? 'selected' : '' ?>>Buron</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tempat_penahanan" name="tempat_penahanan"
                                    value="<?= old('tempat_penahanan') ?>" placeholder="Contoh: Polsek Lunang Silaut, Rutan Solok, dll">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="alamat" name="alamat" rows="3"
                            placeholder="Alamat lengkap tersangka" required><?= old('alamat') ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="pasal_yang_disangkakan" name="pasal_yang_disangkakan" rows="2"
                            placeholder="Pasal-pasal yang disangkakan kepada tersangka"><?= old('pasal_yang_disangkakan') ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="barang_bukti">Barang Bukti</label>
                        <textarea class="form-control" id="barang_bukti" name="barang_bukti" rows="2"
                            placeholder="Daftar barang bukti yang berkaitan dengan tersangka"><?= old('barang_bukti') ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="keterangan">Keterangan Tambahan</label>
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="2"
                            placeholder="Keterangan tambahan mengenai tersangka"><?= old('keterangan') ?></textarea>
                    </div>
                </div>
            </div>
        </div>
